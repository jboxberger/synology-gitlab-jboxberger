...
wizard_m10_desc="Please enter the administrator credentials of MariaDB 10 to proceed with GitLab database settings."
...
wizard_migrate_note="The latest version of GitLab only supports MariaDB 10.<br>The system has detected an existing MariaDB 5 database.<br>In the next step, your database will be migrated from MariaDB 5 to MariaDB 10.<br><br>Please enter the administrator credentials of MariaDB 5 to proceed with the installation."
wizard_migrate_title="Migrate GitLab Database"
